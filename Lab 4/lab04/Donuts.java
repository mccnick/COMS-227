...
public class Donuts
{
  ...
  private static double donutHelper(int donuts, int coffees)
  {
    ...
    int freeCoffees = dozens * 2; // free coffees 
    coffees = coffees - freeCoffees; // updated coffees including free ones
    double donutCost = (dozens * 8.00) + (singles * .75); // per dozen and per single
